...
var buff_type_list = ["immunity", "spell_immunity", "critical_immunity", "taunt", "stealth", "silenced", "disarmed", "stunned", "parry", "insulation", "speed_modifier", "attack_rng_modifier", "attack_speed_modifier", "melee_attack_damage_modifier", "ranged_attack_damage_modifier", "continuous_hp_modifier", "continuous_mp_modifier", "armor_modifier", "max_mp_modifier", "max_hp_modifier", "critical_rate_modifier", "critical_damage_modifier", "evasion_rate_modifier", "life_steal_rate_modifier", "reflect_damage_modifier"]
