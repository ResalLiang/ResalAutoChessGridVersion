...
@onready var normal_button: TextureButton = $VBox/preset_buttons/normal_button
...
func _ready():
	...
	if slow_button.pressed.connect(func(): _set_preset_speed(0.5)) != OK:
		print("slow_button.pressed connect fail!")
	if normal_button.pressed.connect(func(): _set_preset_speed(1.0)) != OK:
		print("normal_button.pressed connect fail!")
	if fast_button.pressed.connect(func(): _set_preset_speed(5.0)) != OK:
		print("fast_button.pressed connect fail!")
