...
@onready var game_container: Control = $game_container
...
# 显示主菜单
func show_main_menu():
	_transition_to_scene("res://scene/menu.tscn", menu_container)
	current_scene_name = "menu"
	#current_scene.game_started.connect(show_game)
# 显示游戏场景
func show_game():
	_transition_to_scene("res://scene/game.tscn", game_container)
	current_scene_name = "game"

# 显示设置菜单
func show_settings():
	_transition_to_scene("res://scene/menus/SettingsMenu.tscn", menu_container)
	current_scene_name = "setting"
